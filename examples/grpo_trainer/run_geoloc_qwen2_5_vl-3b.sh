...
python3 -m verl.trainer.main_ppo \
    ...
    custom_reward_function.name=geoloc_euclidean_reward_function \
    trainer.critic_warmup=0 \
    trainer.logger='["console","wandb"]' \
    trainer.project_name='spatialvl_rl' \
    trainer.experiment_name='qwen2_5_vl_3b_geoloc_euclidean' \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=1 \
    trainer.save_freq=20 \
    trainer.default_local_dir=/mnt/sh/mmvision/home/jonahli/save/checkpoints_rl/spatialvl_rl/qwen2_5_vl_3b_geoloc_euclidean \
    trainer.test_freq=5 \
