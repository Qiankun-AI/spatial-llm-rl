...
REWARD_FUNCTION_PATH="$SCRIPT_DIR/geoloc_reward_function.py"
...
python3 -m verl.trainer.main_ppo \
    ...
    reward_model.custom_reward_function.path="$REWARD_FUNCTION_PATH" \
    reward_model.custom_reward_function.name=geoloc_euclidean_reward_function \
    ...
    trainer.project_name='verl_grpo_geoloc' \
    trainer.experiment_name='qwen2_5_vl_7b_geoloc_haversine' \
